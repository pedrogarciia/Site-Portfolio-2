...
Website portfólio pessoal *one page*, minimalista, desenvolvido para apresentar quem sou, um pouco sobre minha trajetória e meus projetos futuros como desenvolvedor.
 
## 🔗 Demo
 
## ✨ Sobre o projeto
 
Portfólio de uma única página (*single page*), dividido em três seções navegáveis por um menu fixo no topo:
